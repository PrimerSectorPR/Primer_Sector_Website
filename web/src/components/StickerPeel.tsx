...
const StickerPeel: React.FC<StickerPeelProps> = ({
    ...
    // Removed Draggable initialization and resize logic
    ...
    return (
        <div
            className={`absolute transform-gpu pointer-events-none ${className}`}
            style={cssVars}
        >
            <style
          ...
          .sticker-container.force-hover .sticker-main,
          ...
          .sticker-container.force-hover .sticker-flap,
        ...
        `
            ...
            <div
                className={`sticker-container relative select-none touch-none sm:touch-auto ${forceHover ? 'force-hover' : ''}`}
                ref={containerRef}
                style={{
            ...
            >
                <div className="sticker-main pointer-events-auto" style={stickerMainStyle}>
                    <div style={{ filter: 'url(#pointLight)' }}>
                        <img
                            src={imageSrc}
                            alt=""
                            className="block border-4 border-black box-border"
                            style={imageStyle}
                            draggable="false"
